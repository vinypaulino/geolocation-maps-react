...
export class Route {
  ...
  constructor(options: {
    ...
    const strokeColor = (this.endMarker.getIcon() as google.maps.ReadonlySymbol)
    ...
    this.directionsRenderer.setMap(this.endMarker.getMap() as google.maps.Map);
    this.calculateRoute();
  }
    ...
    new google.maps.DirectionsService().route(
      {
        ...
        // the model of travel that you want (driving, walking, bicycling, transit)
      ...
      (result, status) => {
        ...
        throw new Error(`error fetching directions ${result}`);
      }
    );
  }
}
...
export const makeBicycleIcon = (): string =>
